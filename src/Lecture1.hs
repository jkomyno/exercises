...
lowerAndGreater n list = let
    countLower   = length $ filter (< n) list
    countGreater = length $ filter (> n) list
    in show n ++ " is greater than " ++ show countLower ++ " elements and lower than " ++ show countGreater ++ " elements"
